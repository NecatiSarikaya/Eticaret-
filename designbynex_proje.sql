...
--
-- Host: localhost    Database: designbynex_proje
-- ------------------------------------------------------
...
--
-- Dumping data for table `tblayar`
--

LOCK TABLES `tblayar` WRITE;
/*!40000 ALTER TABLE `tblayar` DISABLE KEYS */;
INSERT INTO `tblayar` (`ayar_id`, `ayar_logo`, `ayar_url`, `ayar_title`, `ayar_description`, `ayar_keywords`, `ayar_author`, `ayar_tel`, `ayar_gsm`, `ayar_faks`, `ayar_mail`, `ayar_ilce`, `ayar_il`, `ayar_adres`, `ayar_mesai`, `ayar_maps`, `ayar_bakim`) VALUES (0,'/29008Untitled-1.png','www.designbynex.com','MY BOOKS','Lorem Ipsum, dizgi ve baskı endüstrisinde kullanılan mıgır metinlerdir','Teknoloji,Kitap','NECATİ SARIKAYA','05357723751','02124895656','12121212122','mybooks@mail.com','MALTEPE','İSTANBUL','İSTANBUL/MALTEPE/34852/NO-2','09:00-17:00','https://www.google.com.tr/maps','1');
/*!40000 ALTER TABLE `tblayar` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tblbanka`
--

DROP TABLE IF EXISTS `tblbanka`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `tblbanka`
--

LOCK TABLES `tblbanka` WRITE;
/*!40000 ALTER TABLE `tblbanka` DISABLE KEYS */;
INSERT INTO `tblbanka` (`banka_id`, `banka_ad`, `banka_iban`, `banka_hesap_adsoyad`, `banka_durum`) VALUES (1,'GARANTİ','TR5600062000 00012990022604 ','CEM SARIKAYA','1'),(5,'YAPIKREDİ','TR5600062000 00012990022604 ','NECATİ SARIKAYA','0');
/*!40000 ALTER TABLE `tblbanka` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tblkategori` (`kategori_id`, `kategori_adi`, `kategori_ust`, `kategori_url`, `kategori_seourl`, `kategori_durum`, `kategori_sira`) VALUES (41,'Grafik Tasarım',0,NULL,'grafik-tasarim','1',0),(42,'Hobi',0,NULL,'hobi','1',0),(43,'Programlama',0,NULL,'programlama','1',0),(49,' Mobil Programlama',43,NULL,'mobil-programlama','1',0),(50,'Edebiyat',0,NULL,'edebiyat','1',0),(51,'Sanat - Tasarım',0,NULL,'sanat-tasarim','1',0);
/*!40000 ALTER TABLE `tblkategori` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tblmarkalar`
--

DROP TABLE IF EXISTS `tblmarkalar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `tblmarkalar`
--

LOCK TABLES `tblmarkalar` WRITE;
/*!40000 ALTER TABLE `tblmarkalar` DISABLE KEYS */;
/*!40000 ALTER TABLE `tblmarkalar` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tblmenu` (`menu_id`, `menu_ust`, `menu_adi`, `menu_url`, `menu_seourl`, `menu_durum`, `menu_sira`) VALUES (1,0,'Kitaplar','urunler','kitaplar','1',1),(3,0,'Hakkımızda','hakkimizda','hakkimizda','1',2),(4,0,'İletişim','iletisim','iletisim','1',3);
/*!40000 ALTER TABLE `tblmenu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tblresim`
--

DROP TABLE IF EXISTS `tblresim`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `tblresim`
--

LOCK TABLES `tblresim` WRITE;
/*!40000 ALTER TABLE `tblresim` DISABLE KEYS */;
/*!40000 ALTER TABLE `tblresim` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tblsepet`
--

DROP TABLE IF EXISTS `tblsepet`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=119 DEFAULT CHARSET=utf32 COLLATE=utf32_turkish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tblsepet`
--

LOCK TABLES `tblsepet` WRITE;
/*!40000 ALTER TABLE `tblsepet` DISABLE KEYS */;
INSERT INTO `tblsepet` (`sepet_id`, `kullanici_id`, `urun_id`, `urun_adet`) VALUES (54,34,14,1),(55,35,15,1),(56,35,14,1),(61,39,2,1),(118,42,23,1);
/*!40000 ALTER TABLE `tblsepet` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tblsiparis`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=190083 DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tblsiparis`
--

LOCK TABLES `tblsiparis` WRITE;
/*!40000 ALTER TABLE `tblsiparis` DISABLE KEYS */;
INSERT INTO `tblsiparis` (`siparis_id`, `siparis_zaman`, `siparis_no`, `kullanici_id`, `siparis_toplam`, `siparis_tip`, `siparis_banka`, `siparis_durum`) VALUES (190054,'2018-05-18 16:58:57',NULL,38,1000.00,'Banka Havalesi','GARANTİ',0),(190073,'2018-05-29 11:17:38',NULL,38,69.00,'Banka Havalesi','GARANTİ',2),(190074,'2018-05-29 14:45:59',NULL,27,86.00,'Banka Havalesi','GARANTİ',2),(190075,'2018-05-29 20:35:45',NULL,46,17.00,'Banka Havalesi','GARANTİ',0),(190076,'2018-05-30 07:03:01',NULL,47,144.00,'Banka Havalesi','GARANTİ',0),(190077,'2018-05-30 16:15:38',NULL,46,30.00,'Banka Havalesi','GARANTİ',0),(190078,'2018-05-30 19:41:38',NULL,46,69.00,'Banka Havalesi','GARANTİ',3),(190079,'2018-05-31 20:35:53',NULL,27,90.00,'Banka Havalesi','GARANTİ',2),(190080,'2018-07-01 17:24:19',NULL,0,0.00,'Banka Havalesi','GARANTİ',0),(190081,'2018-07-01 17:24:21',NULL,49,13.00,'Banka Havalesi','GARANTİ',1),(190082,'2018-09-20 16:10:45',NULL,51,56.00,'Banka Havalesi','GARANTİ',3);
/*!40000 ALTER TABLE `tblsiparis` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tblsiparis_detay`
--

DROP TABLE IF EXISTS `tblsiparis_detay`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf32 COLLATE=utf32_turkish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tblsiparis_detay`
--

LOCK TABLES `tblsiparis_detay` WRITE;
/*!40000 ALTER TABLE `tblsiparis_detay` DISABLE KEYS */;
INSERT INTO `tblsiparis_detay` (`siparisdetay_id`, `siparis_id`, `urun_id`, `urun_fiyat`, `urun_adet`) VALUES (34,190046,2,500.00,1),(35,190046,2,500.00,1),(36,190052,2,500.00,1),(37,190052,2,500.00,1),(38,190053,2,500.00,1),(39,190053,2,500.00,1),(40,190053,2,500.00,1),(41,190053,2,500.00,1),(42,190053,2,500.00,1),(43,190053,2,500.00,1),(44,190054,2,500.00,1),(45,190054,2,500.00,1),(46,190055,2,500.00,1),(47,190055,2,500.00,1),(48,190056,2,500.00,1),(49,190057,2,500.00,1),(50,190057,2,500.00,5),(51,190058,7,35.00,5),(52,190059,24,56.00,1),(53,190059,22,17.00,1),(54,190060,4,35.00,1),(55,190060,22,17.00,1),(56,190060,23,13.00,1),(57,190060,7,35.00,1),(58,190061,23,13.00,1),(59,190061,22,17.00,1),(60,190063,23,13.00,2),(61,190064,22,17.00,1),(62,190064,20,35.00,1),(63,190065,24,56.00,28),(64,190066,24,56.00,1),(65,190067,4,35.00,15),(66,190068,24,56.00,100000000),(67,190069,24,56.00,1),(68,190069,23,13.00,1),(69,190069,24,56.00,1),(70,190069,23,13.00,1),(71,190070,24,56.00,1),(72,190070,23,13.00,1),(73,190070,22,17.00,1),(74,190070,23,13.00,1),(75,190070,24,56.00,5),(76,190071,6,50.00,1),(77,190071,22,17.00,1),(78,190072,24,56.00,1),(79,190073,24,56.00,1),(80,190073,23,13.00,1),(81,190074,24,56.00,1),(82,190074,23,13.00,1),(83,190074,22,17.00,1),(84,190075,22,17.00,1),(85,190076,24,56.00,1),(86,190076,6,50.00,1),(87,190076,18,38.00,1),(88,190077,23,13.00,1),(89,190077,22,17.00,1),(90,190078,24,56.00,1),(91,190078,23,13.00,1),(92,190079,24,56.00,1),(93,190079,22,17.00,1),(94,190079,22,17.00,1),(95,190080,24,56.00,1),(96,190081,23,13.00,1),(97,190082,24,56.00,1);
/*!40000 ALTER TABLE `tblsiparis_detay` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf32 COLLATE=utf32_turkish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tblslider` (`slider_id`, `slider_ad`, `slider_resimyol`, `slider_link`, `slider_durum`) VALUES (23,'2','/25728282622637725030Başlıksız-1.png','','0'),(24,'ş','/30130227532655230140Başlıksız-1.png','','0'),(26,'3','/23715209313126025936deneme.png','','0');
/*!40000 ALTER TABLE `tblslider` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tblurun_resim`
--

DROP TABLE IF EXISTS `tblurun_resim`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf32 COLLATE=utf32_turkish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tblurun_resim`
--

LOCK TABLES `tblurun_resim` WRITE;
/*!40000 ALTER TABLE `tblurun_resim` DISABLE KEYS */;
INSERT INTO `tblurun_resim` (`urunfoto_id`, `urun_id`, `urunfoto_resimyol`, `urunfoto_sira`) VALUES (5,3,'/26043219252578821022127274.png',0),(7,4,'/22087256772263320724164904.png',0),(8,6,'/28187305522493020416180341.png',0),(9,7,'/22626315322651830787190905.png',0),(10,8,'/2045626544211463146195697.png',0),(12,5,'/2134725876310092420295697.png',0),(13,9,'/2495023410269803080295697.png',0),(14,10,'/276832008524966307831726.png',0),(15,11,'/214992741124480275331726.png',0),(16,12,'/2608727456288912518695844.png',0),(17,13,'/29381264712556331670204627.png',0),(19,14,'/24968246332040423495204627.png',0),(20,15,'/27435306862674431695204627.png',0),(21,16,'/29080263522175230095204627.png',0),(22,17,'/30968283852461831164204627.png',0),(23,18,'/24577252232439220547204627.png',0),(24,19,'/29278288703031225880128247.png',0),(26,21,'/317522282028303266550001750839001-1.jpg',0),(29,22,'/317272988320048205230001746599001-1.jpg',0),(30,20,'/214352459621737311891338 (1).png',0),(32,23,'/318852093324780279610001758034001-1.jpg',0),(33,24,'/306252948224457240720000000162857-1.jpg',0);
/*!40000 ALTER TABLE `tblurun_resim` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tblurunler`
--
...
--
-- Dumping data for table `tbluyeler`
--

LOCK TABLES `tbluyeler` WRITE;
/*!40000 ALTER TABLE `tbluyeler` DISABLE KEYS */;
INSERT INTO `tbluyeler` (`kullanici_id`, `kullanici_adsoyad`, `kullanici_yetki`, `kullanici_adres`, `kullanici_mail`, `kullanici_tel`, `kullanici_password`, `kullanici_kayit_tarihi`, `kullanici_img`, `kullanici_durum`, `kullanici_adi`) VALUES (27,'Necati Sarıkaya','1','Lorem Ipsum, dizgi ve baskı endüstrisinde kullanılan mıgır metinlerdir. Lorem Ipsum, adı bilinmeyen bir matbaacının bir hurufat numune kitabı oluşturmak üzere bir yazı galerisini alarak karıştırdığı 1500\'lerden beri endüstri standardı sahte metinler olarak kullanılmıştır. Beşyüz yıl boyunca varlığını sürdürmekle kalmamış, aynı zamanda pek değişmeden elektronik dizgiye de sıçramıştır. 1960\'larda Lorem Ipsum pasajları da içeren Letraset yapraklarının yayınlanması ile ve yakın zamanda Aldus PageMaker gibi Lorem Ipsum sürümleri içeren masaüstü yayıncılık yazılımları sile popüler olmuştur.','necatisarikayaa@gmail.com','05353533535','81dc9bdb52d04dc20036dbd8313ed055','0000-00-00 00:00:00','/31238photo.jpg',1,'admin'),(38,'Cem Sarıkaya','0','frnrnrmfrf','cem@gmail.com','','e10adc3949ba59abbe56e057f20f883e','2018-05-17 18:32:44','/31238photo.jpg',0,''),(40,'cem sarı','0','','cem_gg@hotmail.com','','9b6dad86e4c422c3eacd921a59d2f306','2018-05-19 00:06:25','/31238photo.jpg',0,''),(42,'furkan şenol','0','','asd@asd.com','','1adbb3178591fd5bb0c248518f39bf6d','2018-05-25 00:44:10','/31238photo.jpg',0,''),(44,'mertcan hınıslı','0','','mertcanhnsl@gmail.com','','e10adc3949ba59abbe56e057f20f883e','2018-05-25 00:44:48','/31238photo.jpg',0,''),(45,'Deneme','0','','necatisarikayaa@icloud.com','','e10adc3949ba59abbe56e057f20f883e','2018-05-28 14:04:33','/31238photo.jpg',0,''),(46,'neco projenden kopya cekiom','0','sdfasf','asdf@asdf.com','','1adbb3178591fd5bb0c248518f39bf6d','2018-05-29 23:34:08','/31238photo.jpg',0,''),(47,'Necati Sarıkaya','0',' Maltepe İstanbul','necatisarikaya@gmail.com','','e10adc3949ba59abbe56e057f20f883e','2018-05-30 10:01:57','/31238photo.jpg',0,''),(48,'nbrnbr','0','Adres kodu ülke sınırları içindeki tüm konutlara ait 10 haneli özel bir numaradır. 1 Mart 2013\'den itibaren zorunlu deprem sigortası poliçesi işlemlerinde ve daha birçok işlemde kullanılmaya başlanıyor. Zorunlu deprem sigortanızı kolayca yaptırmak ve deprem sonrasında size vakit kaybetmeden ulaşmamızı sağlamak için adres kodunuzu mutlaka öğrenin!','nbrnbr@gmail.com','','e10adc3949ba59abbe56e057f20f883e','2018-05-31 10:27:06','/31238photo.jpg',0,''),(49,'mehmet berk şennaz','0','sanane aq','mehmets9861@hotmail.com','','c9c2e8c848e6b7b2129646852701d3a4','2018-07-01 20:21:29','/31238photo.jpg',0,''),(50,'necatis','0','dasdasd','necati@da.com','','e10adc3949ba59abbe56e057f20f883e','2018-08-12 02:29:51','',0,''),(51,'Taner Cevher','0','Hehehohhehehehe','TRCevher@gmail.com','','fcea920f7412b5da7be0cf42b8c93759','2018-09-20 19:10:13','',0,'');
/*!40000 ALTER TABLE `tbluyeler` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tblyorum`
--

DROP TABLE IF EXISTS `tblyorum`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `tblyorum`
--

LOCK TABLES `tblyorum` WRITE;
/*!40000 ALTER TABLE `tblyorum` DISABLE KEYS */;
INSERT INTO `tblyorum` (`yorum_id`, `kullanici_id`, `urun_id`, `yorum_detay`, `yorum_zaman`, `yorum_onay`) VALUES (1,51,24,'Ürün fenne','2018-09-20 16:10:34','1');
/*!40000 ALTER TABLE `tblyorum` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'designbynex_proje'
--

--
-- Dumping routines for database 'designbynex_proje'
--
...
-- Dump completed on 2018-09-28 13:50:44
