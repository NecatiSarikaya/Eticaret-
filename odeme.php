						...
						<div class="category-tab shop-details-tab"><!--category-tab-->
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade active in" id="reviews" >
									<div class="col-sm-12">
										<p><b>Ödeme yapacağınız bankayı seçtip  belirtilen İban Numarasına parayı yatırdıktan sonra</b></p>
										<p><b style="color: red;">mybooks@gmail.com</b>'a aldığınız makbuzu atınız</p>
